  ...
  useEffect(() => {
    ...
    class App {
      ...
      init() {
        ...
        // Attach hover listeners to the parent container if onHover is enabled
        if (options.enableHover) {
          const parentContainer = this.container.parentElement;
          if (parentContainer) {
            parentContainer.addEventListener('mouseenter', this.onMouseEnter);
            parentContainer.addEventListener('mouseleave', this.onMouseLeave);
      ...
      dispose() {
        ...
        if (this.container) {
          if (this.parentContainer) {
            this.parentContainer.removeEventListener('mouseenter', this.onMouseEnter);
            this.parentContainer.removeEventListener('mouseleave', this.onMouseLeave);
          }
